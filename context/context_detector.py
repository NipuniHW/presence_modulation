...
class ContextDetector(Process):
    ...
    def __init__(self, output_queue):
        ...
        self.model = load_model(r"/home/nipuni/Documents/Codes/q-learning/emergency_model.h5")
        self.input_shape = self.model.input_shape[1:] 

        # Load the trained Naive Bayes model for final state classification
        self.nb_model = joblib.load(r"/home/nipuni/Documents/Codes/q-learning/final_NB_model.joblib")
    ...
    def run(self):
        while self.running:
            ...
            ambient_class, ambient_conf, ambient_label = self.classify_real_time_audio(self.model, self.input_shape, sr=16000)

            # Step 2: Process speech-to-text and sentiment analysis
            speech_class, sentiment_conf, keyword_conf, speech_label, transcription_text = self.process_speech_to_text_and_sentiment()
            ...
            self.output_queue.put((current_time, final_label))